...
*{box-sizing:border-box}html{min-height:100%;background:var(--bg)}body{margin:0;min-height:100vh;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:radial-gradient(circle at 15% 0%,rgba(109,93,252,.22),transparent 34rem),radial-gradient(circle at 92% 12%,rgba(139,92,246,.16),transparent 28rem),linear-gradient(180deg,#08090a,#0b0b11 45%,#08090a);background-attachment:fixed;background-color:#08090a;color:var(--text);padding:clamp(16px,3vw,32px);font-feature-settings:"cv01","ss03"}
